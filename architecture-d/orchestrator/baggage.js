 ...
 *
 * Returns `{}` for any non-string input (null, undefined, number, object,
 * etc.) so callers don't need to defensively coerce — a baggage header
 * that isn't a string is, by definition, absent.
 */
