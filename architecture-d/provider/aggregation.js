...
// Treat null/undefined/non-object entries as invisible to the
// aggregation functions; otherwise a malformed log would crash the
// derivations with "Cannot read properties of null".
 ...
 * Defensive against entries that lack `fanout_targets` so a malformed
 * log (custom mitigation, imported file) doesn't crash the report.
 */
