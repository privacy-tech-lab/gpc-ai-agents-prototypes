/**
 * Synthesis Agent — pure reasoning, no tools. Identical role to
 * mcp/agents/synthesis_agent.js: receives raw search results and synthesises
 * them into a structured itinerary. Calling no tools means there is nothing
 * to block here in either protocol.
 */
 ...
 */
async function run({ query, rawResults, timing = null }) {
