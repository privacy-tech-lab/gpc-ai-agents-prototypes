/**
 * Baseline run: no GPC.
 * All secondary pipelines execute; analytics, training, and ad store are written.
 */
...
const RESULT_FILE = path.join(OUTPUT_DIR, 'baseline_result.json');
...
async function main() {
  ...
  console.log('Running baseline (no GPC)...\n');
