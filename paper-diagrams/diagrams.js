...
const DIAGRAMS = [
  ...
  // Category E: Delegation
  {
    ...
    nodes: [
      ...
      { id: 'askt', label: 'Ask first:\nbooking, passport transfer' },
      { id: 'vd', label: 'Vendor proposed a tier?', decision: true },
      { id: 'gpcq', label: 'GPC active?', decision: true },
      { id: 'vdauto', label: 'Vendor default applies:\nfare tracking runs' },
      { id: 'p', label: 'User available?', decision: true },
      { id: 'exec', label: 'Action executes', role: 'respected' },
      { id: 'appr', label: 'Executed after approval', role: 'respected' },
      { id: 'dec', label: 'Declined, not assumed', role: 'enforced' },
    ],
    edges: [
      { from: 'req', to: 'enc' },
      { from: 'enc', to: 'ua' },
      { from: 'ua', to: 'auto', label: 'yes, autonomous' },
      { from: 'ua', to: 'askt', label: 'yes, ask first' },
      { from: 'ua', to: 'vd', label: 'no' },
      { from: 'auto', to: 'exec' },
      { from: 'askt', to: 'p' },
      { from: 'vd', to: 'gpcq', label: 'yes' },
      { from: 'vd', to: 'p', label: 'no' },
      { from: 'gpcq', to: 'vdauto', label: 'no' },
      { from: 'gpcq', to: 'p', label: 'yes' },
      { from: 'vdauto', to: 'exec' },
      { from: 'p', to: 'appr', label: 'yes, approves' },
      { from: 'p', to: 'dec', label: 'no user available' },
    ],
    notes: [
      { target: 'dec', text: 'The user assignment overrides the vendor proposal. GPC voids vendor defaults. Unassigned falls to the most restrictive treatment' },
    ],
  },
  {
    id: 'e1',
