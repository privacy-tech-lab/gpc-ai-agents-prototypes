/**
 * Shared LLM turn loop — identical to Architecture A.
 *
 * Uses tool_choice="required" until every required tool has been attempted,
 * then switches to "auto" so the model can write a final response.
 */
